<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4" x-data="model()">
      @include('livewire.son-de-cuatro.admin.form')
    </div>
    <div class="col-lg-8" x-data="model()">
      @include('livewire.son-de-cuatro.admin.table')
    </div>
  </div>
</div>
...
<script>
  ...
  window.addEventListener('livewire:load', ()=>{
    ...
    Livewire.on('updateAmount', (price, expense) => {
      document.getElementById('price').value = formatCurrency(price, 0);
      document.getElementById('expense').value = formatCurrency(expense, 0);
    })
